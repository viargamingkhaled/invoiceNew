            ...
            <div className="space-y-6">
              <Card className="p-6" padding="md">
                ...
                <div className="mt-3 grid gap-3 text-sm text-slate-700">
                  <div className="flex items-center justify-between"><div>Sales</div><a className="underline" href="mailto:info@mail.com">info@mail.com</a></div>
                  <div className="flex items-center justify-between"><div>Support</div><a className="underline" href="mailto:info@mail.com">info@mail.com</a></div>
                  <div className="flex items-center justify-between"><div>Billing</div><a className="underline" href="mailto:info@mail.com">info@mail.com</a></div>
                  <div className="flex items-center justify-between"><div>Privacy (DPO)</div><a className="underline" href="mailto:info@mail.com">info@mail.com</a></div>
              ...
              <Card className="p-6" padding="md">
                ...
                <div className="mt-4 h-40 rounded-xl bg-slate-100 border border-black/10 flex items-center justify-center text-slate-500 text-sm">Map placeholder</div>
              </Card>
            </div>
        </div>
