...
4.2. We may suspend or terminate accounts involved in the above, investigate suspected abuse, and cooperate with law enforcement where required.` 
  ...
  { 
    ...
    body: `5.1. Token top-ups are offered as one-time purchases: Beginner (£10), Pro (£50), Business (£100), and Custom (user-defined amount). Prices are shown in GBP; indicative equivalents may be displayed in EUR.
...
5.3. Indicative reference rate: 100 Tokens = £1.00. Displayed equivalents in EUR are for convenience only and may vary due to FX and provider fees.
