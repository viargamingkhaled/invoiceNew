            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="flex flex-col items-center space-y-2">
                  <div className="w-16 h-16 rounded-full overflow-hidden bg-[#F6F7F8] flex items-center justify-center">
                    {reviews[currentReview].photo ? (
                      <Image
                        src={reviews[currentReview].photo}
                        alt={`${reviews[currentReview].author} photo`}
                        width={64}
                        height={64}
                        ...
                        onError={(e) => {
                          ...
                          if (parent) {
                            parent.innerHTML = `
                              <span class="text-[#0F766E] text-lg font-bold">
                      ...
                      <span className="text-[#0F766E] text-lg font-bold">
                        {reviews[currentReview].author.charAt(0)}
                      </span>
                    )}
                  </div>
